<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Email Configuration.aspx.cs" Inherits="MyLogicRetail.Web.Email_Configuration" %>
                        ...
                        <nav class="navbar-custom">
                            ...
                            <ul class="list-inline menu-left mb-0">
                                ...
                                <li class="hide-phone list-inline-item app-search">
                                    <h3 class="page-title">Email Configration</h3>
                                </li>
                            </ul>
                                    ...
                                    <div class=" m-b-30">
                                        <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 text-right">Email Address</label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
            <input type="password" class="form-control" required placeholder="Password"/></div>                                         
                                                    
                                                </div>
                                                
                                                <div class="form-group row">
                                                    <label class="col-md-3 text-right">SMTP Server</label>
                                                    <div class="col-md-9">
                                                    <input type="text" class="form-control" required placeholder="smtp.gmail.com"/>
                                                    </div>
                                                </div>
<div class="form-group row">
                                                    <label class="col-md-3 text-right">Port</label>
                                                   <div class="col-md-9">
                                                    <input type="text" class="form-control" required placeholder="Port"/>
                                                    </div>
                                                </div>

<div class="form-group row">
                                                    <label class="col-md-3 text-right">TTL</label>
                                                    <div class="col-md-9">
...
<div class="form-group row">
                                                    <label class="col-md-3 text-right">Message Template</label>
                                                   <div class="col-md-9">
