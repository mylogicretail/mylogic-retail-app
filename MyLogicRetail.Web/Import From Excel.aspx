<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Import From Excel.aspx.cs" Inherits="MyLogicRetail.Web.Import_From_Excel" %>
                        ...
                        <nav class="navbar-custom">
                            ...
                            <ul class="list-inline menu-left mb-0">
                                ...
                                <li class="hide-phone list-inline-item app-search">
                                    <h3 class="page-title">Item Master - Import From Excel</h3>
                                </li>
                            </ul>
                                    ...
                                    <div class=" m-b-30">
                                        <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 text-right">Group Code</label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 text-right">Group Name</label>
                                                    <div class="col-md-9">
            <input type="text" class="form-control" required placeholder="Auto pop-up"/></div>                                         
                                                    
                                                </div>
												
												<div class="form-group row">
                                                    <label class="col-md-3 text-right">Sub Group Code</label>
                                                    <div class="col-md-9">
                                                    <input type="text" class="form-control" required placeholder="Sub Group Code"/></div>
                                                </div>

                                                <div class="form-group row">
                                                    <label class="col-md-3 text-right">Sub Group Name</label>
                                                    <div class="col-md-9">
            <input type="text" class="form-control" required placeholder="Sub Group Name"/></div>                                         
