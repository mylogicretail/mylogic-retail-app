<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Item Category.aspx.cs" Inherits="MyLogicRetail.Web.Item_Category" %>
                                    ...
                                    <div class=" m-b-30">
                                        <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                    <input type="text" class="form-control" required placeholder="Group Code"/></div>
                                                </div>

                                                <div class="form-group row">
                                                    <label class="col-md-3 text-right">Group Name</label>
                                                    <div class="col-md-9">
            <input type="text" class="form-control" required placeholder="Group Name"/></div>                                         
