<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Brand Master.aspx.cs" Inherits="MyLogicRetail.Web.Brand_Master" %>
                        ...
                        <nav class="navbar-custom">
                            ...
                            <ul class="list-inline menu-left mb-0">
                                ...
                                <li class="hide-phone list-inline-item app-search">
                                    <h3 class="page-title">Brand Master</h3>
                                </li>
                            </ul>
                                    ...
                                    <div class=" m-b-30">
                                        <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 text-right">Brand Code</label>
                                                    <div class="col-md-9">
                                                    <input type="text" class="form-control" required placeholder="Brand Code"/></div>
                                                </div>

                                                <div class="form-group row">
                                                    <label class="col-md-3 text-right">Brand Name</label>
                                                    <div class="col-md-9">
            <input type="text" class="form-control" required placeholder="Brand Name"/></div>                                         
